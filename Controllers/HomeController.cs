...
namespace OdeToFood.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Create(Restaurant model)
        {
            ...
            {
                var restaurant = new Restaurant {Name = model.Name, Cuisine = model.Cuisine,Location = model.Location,Phone = model.Phone,CuisineDays = model.CuisineDays,Description = model.Description};
